...
AIR.CiCreateWizardP1 = Ext.extend(AIR.AirView, {
	...
	reset: function() {
		...
		if(r) {
			...
			//falls durch CI Auswahl mit Kat1 != Application eine f�r Application unpassende Kat2 Liste gefiltert wurde,
			//f�r den Wizard wieder zur�cksetzen:
	...
	updateLabels: function(labels) {
		...
		//geh�rt hier eigentlich nicht hin. Da aber keine update Methode gibt und der IE diese cb zerschiesst 
		//oder gar nicht darstellt wenn cb mit den Attributen disabled: true, und hideTrigger: true konfiguriert wird:
		//AIR.AirAclManager.setAccessMode(this.getComponent('cbCiTypeW'), null); appDetail m�sste �bergeben werden, gibt es hier aber nicht
