				...
				case 'INVALID_MASSNAHME':
					...
					var buttonConfigs = [{
						...
						handler: function() {
							...
							//ist das Verhalten genau umgekehrt. D.h. die unvollst�ndige Massnahme muss wieder ausgew�hlt
							//werden, anstatt das verhnidert wird die n�cshte zu selektieren.
							dynamicWindow.close();
						}
					}*/];
					break;
