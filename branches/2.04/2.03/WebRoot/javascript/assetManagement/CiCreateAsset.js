...
AIR.CiCreateAsset = Ext.extend(AIR.AirView, {
...
//						marginTop: 10
		...
		AIR.CiCreateAsset.superclass.initComponent.call(this);
...
//		this.setFieldLabel(fsSpecialSearchAttributes.getComponent('cbAdvSearchGapResponsibleW'), labels.gapResponsible);
	...
	update: function(data) {
		...
		//oder AirApplicationManager::ciTypeListStore, CiCreateAsset?
...
Ext.reg('AIR.CiCreateAsset', AIR.CiCreateAsset);