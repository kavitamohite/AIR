...
public class ApplicationWSDelegate {
	...
	// ApplicationParamOutput
	public CiItemsResultDTO findApplications(
			ApplicationSearchParamsDTO anwParamInp) {// ApplicationParameterInput
	...
	public CiEntityEditParameterOutput deleteApplication(
			CiEntityParameterInput editInput) {// ApplicationEditParameterOutput
												// ApplicationEditParameterInput
