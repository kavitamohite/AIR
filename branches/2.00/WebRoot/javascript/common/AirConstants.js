...
//	SUPPORTED_COUNTRIES: [AIR.AirConstants.IMG_COUNTRY_EN, AIR.AirConstants.IMG_COUNTRY_DE]
	...
	TABLE_ID_CI_NAME: {
		TABLE_ID_IT_SYSTEM: 'ItSystem',
		TABLE_ID_APPLICATION: 'Application',
		TABLE_ID_ROOM: 'Room',
		TABLE_ID_BUILDING: 'Building',
		TABLE_ID_SITE: 'Standort',
		TABLE_ID_POSITION: 'Schrank',
//		TABLE_ID_HARDWARE_COMPONENT: 19,
		TABLE_ID_TERRAIN: 'Terrain',
		TABLE_ID_WAY: 'Way',
		TABLE_ID_BUILDING_AREA: 'BuildingArea'
//		TABLE_ID_SERVICE: 123
	},
