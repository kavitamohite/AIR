 ...
 * 
 */
public class MassUpdateComplianceControlParameterOutput {

	private String result;

	private String displayMessage; // one message, that should be displayed to
									// the user
	...
	public void setErrorMessage(String code, String replacement) {
		...
		String detailedMessage = errorCodeManager.getErrorMessage(code,
				replacement);
